...
public:
  ...
  void CombineWith(const BulkLinearUpdater& other) {
      tax_.percentage = 100 - (tax_.ComputeFactor()*other.tax_.ComputeFactor()*100);
  ...
  MoneyState Collapse(MoneyState origin, IndexSegment segment) const {
      MoneyState result;
      result.earned = origin.earned*tax_.ComputeFactor() + add_.delta.earned * segment.length();
...
struct AddMoneyRequest : ModifyRequest {
  ...
  void Process(BudgetManager& manager) const override {
    ...
    const double daily_value = income * 1.0 / date_segment.length();
    MoneyState daily_change;
    if(SIGN == 1){
        daily_change.earned = daily_value;
    }else{
        daily_change.spent = daily_value;
...
vector<MoneyState> ProcessRequests(const vector<RequestHolder>& requests) {
  vector<MoneyState> responses;
...
void PrintResponses(const vector<MoneyState>& responses, ostream& stream = cout) {
  for (const MoneyState response : responses) {
    stream << response.ComputeIncome() << endl;
  }
}
...
PayTax 2000-01-02 2000-01-06 13
ComputeIncome 2000-01-02 2000-01-06
PayTax 2000-01-02 2000-01-06 20
ComputeIncome 2000-01-02 2000-01-06
PayTax 2000-01-02 2000-01-06 15
ComputeIncome 2000-01-02 2000-01-06
Spend 2000-01-02 2000-01-06 5
ComputeIncome 2000-01-02 2000-01-06
*/

/*
4
Spend 2001-01-01 2001-01-05 100
PayTax 2001-01-01 2001-01-05 30
Earn 2001-01-01 2001-01-05 300
ComputeIncome 2001-01-01 2001-01-05
*/
